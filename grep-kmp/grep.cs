...
method ComputeLPS(pat: array<byte>) returns (lps: array<int>)
  ...
  ensures forall k: int {:trigger lps[k]} :: (0 <= k < lps.Length ==> 0 <= lps[k]) && (0 <= k < lps.Length ==> lps[k] <= k)
  decreases pat
{
  ...
  while i < pat.Length
    ...
    invariant 0 <= len < i
    invariant forall k: int {:trigger lps[k]} :: (0 <= k < i ==> 0 <= lps[k]) && (0 <= k < i ==> lps[k] <= k)
...
method KMPSearch(txt: array<byte>, pat: array<byte>)
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger[] ComputeLPS(byte[] pat)
    {
      BigInteger[] lps = new BigInteger[0];
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger((pat).Length), "array size exceeds memory limit")];
      lps = _nw0;
      (lps)[(int)((BigInteger.Zero))] = BigInteger.Zero;
      BigInteger _0_len;
      _0_len = BigInteger.Zero;
      BigInteger _1_i;
      _1_i = BigInteger.One;
      while ((_1_i) < (new BigInteger((pat).Length))) {
        if (((pat)[(int)(_1_i)]) == ((pat)[(int)(_0_len)])) {
          _0_len = (_0_len) + (BigInteger.One);
          (lps)[(int)((_1_i))] = _0_len;
          _1_i = (_1_i) + (BigInteger.One);
        } else {
          if ((_0_len).Sign != 0) {
            _0_len = (lps)[(int)((_0_len) - (BigInteger.One))];
          } else {
            (lps)[(int)((_1_i))] = BigInteger.Zero;
            _1_i = (_1_i) + (BigInteger.One);
          }
        }
      }
    ...
    public static void KMPSearch(byte[] txt, byte[] pat, out bool found, out BigInteger index)
    {
      found = false;
      index = BigInteger.Zero;
      BigInteger _0_M;
      _0_M = new BigInteger((pat).Length);
      BigInteger _1_N;
      _1_N = new BigInteger((txt).Length);
      BigInteger[] _2_lps;
      BigInteger[] _out0;
      _out0 = __default.ComputeLPS(pat);
      _2_lps = _out0;
      BigInteger _3_i;
      ...
      while ((_3_i) < (_1_N)) {
        if (((pat)[(int)(_4_j)]) == ((txt)[(int)(_3_i)])) {
          _4_j = (_4_j) + (BigInteger.One);
          _3_i = (_3_i) + (BigInteger.One);
        }
        if ((_4_j) == (_0_M)) {
          bool _rhs0 = true;
          BigInteger _rhs1 = (_3_i) - (_4_j);
          found = _rhs0;
          index = _rhs1;
          return ;
        } else if (((_3_i) < (_1_N)) && (((pat)[(int)(_4_j)]) != ((txt)[(int)(_3_i)]))) {
          if ((_4_j).Sign != 0) {
            _4_j = (_2_lps)[(int)((_4_j) - (BigInteger.One))];
          } else {
            _3_i = (_3_i) + (BigInteger.One);
          }
        }
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _0_numArgs = _out0;
      if ((_0_numArgs) != (3U)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: ./grep <Word> <File>\n")).ToVerbatimString(false));
        return ;
      }
      Dafny.Rune[] _1_wordArg;
      Dafny.Rune[] _out1;
      _out1 = HostConstants.GetCommandLineArg(1UL);
      _1_wordArg = _out1;
      Dafny.Rune[] _2_fileArg;
      Dafny.Rune[] _out2;
      _out2 = HostConstants.GetCommandLineArg(2UL);
      _2_fileArg = _out2;
      if ((new BigInteger((_1_wordArg).Length)).Sign == 0) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Search word cannot be empty.\n")).ToVerbatimString(false));
        return ;
      }
      bool _3_fileExists;
      bool _out3;
      ...
      bool _out4;
      int _out5;
      FileStream.FileLength(_2_fileArg, out _out4, out _out5);
      _4_success = _out4;
      _5_len = _out5;
      ...
      bool _out6;
      FileStream _out7;
      FileStream.Open(_2_fileArg, out _out6, out _out7);
      _6_ok = _out6;
      _7_f = _out7;
      if (!(_6_ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("NO\n")).ToVerbatimString(false));
      ...
      _9_closeOk = _out9;
      byte[] _10_wordBytes;
      byte[] _nw1 = new byte[Dafny.Helpers.ToIntChecked(new BigInteger((_1_wordArg).Length), "array size exceeds memory limit")];
      _10_wordBytes = _nw1;
      BigInteger _11_k;
      _11_k = BigInteger.Zero;
      while ((_11_k) < (new BigInteger((_1_wordArg).Length))) {
        BigInteger _12_charVal;
        _12_charVal = new BigInteger(((_1_wordArg)[(int)(_11_k)]).Value);
        if (((_12_charVal).Sign != -1) && ((_12_charVal) < (new BigInteger(256)))) {
          (_10_wordBytes)[(int)((_11_k))] = (byte)(_12_charVal);
        } else {
          (_10_wordBytes)[(int)((_11_k))] = (byte)(63);
        }
      ...
      bool _out10;
      BigInteger _out11;
      __default.KMPSearch(_8_buffer, _10_wordBytes, out _out10, out _out11);
      _13_found = _out10;
      _14_idx = _out11;
      if (_13_found) {
