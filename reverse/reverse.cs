...
namespace _module {
  ...
  public partial class __default {
    public static byte[] ReverseLines(byte[] input)
    {
      byte[] output = new byte[0];
      byte[] _nw0 = new byte[Dafny.Helpers.ToIntChecked(new BigInteger((input).Length), "array size exceeds memory limit")];
      output = _nw0;
      if ((new BigInteger((input).Length)).Sign == 0) {
        return output;
      }
      BigInteger _0_i;
      _0_i = (new BigInteger((input).Length)) - (BigInteger.One);
      BigInteger _1_out__idx;
      _1_out__idx = BigInteger.Zero;
      BigInteger _2_line__end;
      _2_line__end = new BigInteger((input).Length);
      while ((_0_i).Sign != -1) {
        if ((((input)[(int)(_0_i)]) == ((byte)(10))) || ((_0_i).Sign == 0)) {
          BigInteger _3_start;
          if (((input)[(int)(_0_i)]) == ((byte)(10))) {
            _3_start = (_0_i) + (BigInteger.One);
          } else {
            _3_start = BigInteger.Zero;
          }
          BigInteger _4_len;
          _4_len = (_2_line__end) - (_3_start);
          BigInteger _5_k;
          _5_k = BigInteger.Zero;
          while ((_5_k) < (_4_len)) {
            BigInteger _index0 = (_1_out__idx) + (_5_k);
            (output)[(int)(_index0)] = (input)[(int)((_3_start) + (_5_k))];
            _5_k = (_5_k) + (BigInteger.One);
          }
          _1_out__idx = (_1_out__idx) + (_4_len);
          if (((input)[(int)(_0_i)]) == ((byte)(10))) {
            if ((_1_out__idx) < (new BigInteger((output).Length))) {
              (output)[(int)((_1_out__idx))] = (byte)(10);
              _1_out__idx = (_1_out__idx) + (BigInteger.One);
              _2_line__end = _0_i;
            }
          } else {
            _2_line__end = BigInteger.Zero;
          }
        }
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _0_numArgs = _out0;
      if ((_0_numArgs) != (3U)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: ./reverse <source> <dest>\n")).ToVerbatimString(false));
        return ;
      }
      Dafny.Rune[] _1_srcName;
      Dafny.Rune[] _out1;
      _out1 = HostConstants.GetCommandLineArg(1UL);
      _1_srcName = _out1;
      Dafny.Rune[] _2_dstName;
      Dafny.Rune[] _out2;
      _out2 = HostConstants.GetCommandLineArg(2UL);
      _2_dstName = _out2;
      bool _3_srcExists;
      bool _out3;
      _out3 = FileStream.FileExists(_1_srcName);
      _3_srcExists = _out3;
      bool _4_dstExists;
      bool _out4;
      _out4 = FileStream.FileExists(_2_dstName);
      _4_dstExists = _out4;
      if (!(_3_srcExists)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Source file does not exist.\n")).ToVerbatimString(false));
        return ;
      }
      if (_4_dstExists) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Destination file already exists.\n")).ToVerbatimString(false));
        return ;
      }
      bool _5_success;
      int _6_len;
      bool _out5;
      int _out6;
      FileStream.FileLength(_1_srcName, out _out5, out _out6);
      _5_success = _out5;
      _6_len = _out6;
      if ((!(_5_success)) || ((_6_len) < (0))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Could not determine source file length.\n")).ToVerbatimString(false));
        return ;
      }
      bool _7_ok;
      FileStream _8_srcFile;
      bool _out7;
      FileStream _out8;
      FileStream.Open(_1_srcName, out _out7, out _out8);
      _7_ok = _out7;
      _8_srcFile = _out8;
      if (!(_7_ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Could not open source file.\n")).ToVerbatimString(false));
        return ;
      }
      byte[] _9_buffer;
      byte[] _nw0 = new byte[Dafny.Helpers.ToIntChecked(_6_len, "array size exceeds memory limit")];
      _9_buffer = _nw0;
      bool _out9;
      _out9 = (_8_srcFile).Read((int)(0), _9_buffer, (int)(0), _6_len);
      _7_ok = _out9;
      if (!(_7_ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Failed to read source file.\n")).ToVerbatimString(false));
        return ;
      }
      bool _10_closeOk;
      bool _out10;
      _out10 = (_8_srcFile).Close();
      _10_closeOk = _out10;
      if (!(_7_ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Failed to read source file.\n")).ToVerbatimString(false));
        return ;
      ...
      if (!(_10_closeOk)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Could not close source file.\n")).ToVerbatimString(false));
        return ;
      }
      byte[] _11_outBuffer;
      byte[] _out11;
      _out11 = __default.ReverseLines(_9_buffer);
      _11_outBuffer = _out11;
      bool _12_okDst;
      FileStream _13_dstFile;
      bool _out12;
      FileStream _out13;
      FileStream.Open(_2_dstName, out _out12, out _out13);
      _12_okDst = _out12;
      _13_dstFile = _out13;
      if (!(_12_okDst)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Could not open destination file.\n")).ToVerbatimString(false));
        return ;
      }
      bool _out14;
      _out14 = (_13_dstFile).Write((int)(0), _11_outBuffer, (int)(0), (int)(_11_outBuffer).Length);
      _12_okDst = _out14;
      if (!(_12_okDst)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Failed to write to destination file.\n")).ToVerbatimString(false));
        return ;
      }
      bool _14_closeDstOk;
      bool _out15;
      _out15 = (_13_dstFile).Close();
      _14_closeDstOk = _out15;
      if (!(_14_closeDstOk)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Could not close destination file.\n")).ToVerbatimString(false));
        return ;
      }
      if (_12_okDst) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("File reversed successfully.\n")).ToVerbatimString(false));
      } else {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: Failed to write to destination file.\n")).ToVerbatimString(false));
      }
    }
